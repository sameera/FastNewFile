...
namespace FastNewFile
{
    public partial class FileNameDialog : Window
    {
        ...
        public FileNameDialog(IVsUIShell uIShell, string folder, string defaultExt)
        {
            InitializeComponent();
            ...
            Loaded += (s, e) =>
            {
                //Icon = BitmapFrame.Create(new Uri("pack://application:,,,/FastNewFile;component/Resources/icon.png", UriKind.RelativeOrAbsolute));
                SetRandomTip();
